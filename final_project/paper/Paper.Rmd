...
The phylogram is displayed in Figure \ref{fig:result}.
...
\caption{Resulting phylogram. maize\_v3 and maize\_v4 are two assemblies of the same maize cultivar, medicago1 and medicago2 are two different genotypes.}
\label{fig:result}
\end{figure*}
